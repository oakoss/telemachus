...
- **Stack:** data layer, app framework + deploy, ORM, auth, UI, model/LLM layer, and repo/toolchain are decided ([ADR-001](../decisions/001-data-layer-tanstack-db-electric-pglite.md)–[007](../decisions/007-repo-shape-and-toolchain.md)); only the **server runtime** remains _recommended, not committed_.
