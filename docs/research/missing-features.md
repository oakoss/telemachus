...
- **Status:** Research synthesis, 2026-06-01 (snapshot; re-verify before committing roadmap). **Whitespace re-confirmed 2026-06-07** — a full re-check of all 10 projects found every Tier-1 ◆ still net-new (see [`feature-matrix.md`](feature-matrix.md)).
...
| --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **Work surface** — in-conversation pinned-message → checklist + notes scratchpad beside the thread                                      | Open WebUI _global_ Notes; OpenAI shipped pinned _chats_; Lobe Activity.notes (not per-thread)                     | OpenAI Dev Community ×2 + shadcn X — recurs across ≥2 communities (the earlier LibreChat #6743 citation no longer resolves upstream, re-checked 2026-06-07) | **Low** — pure reactive UI over `pins`/`notes` collections; chat-only spine. First differentiator (roadmap Rung 2).              |
